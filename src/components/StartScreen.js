        ...
        <div id="start-screen-container">
            <div className="form">
                ...
                <div className="form_field" key="name">
                    ...
                    <input className="form_input" id="name" onChange={e => setName(e.target.value)} />
                </div>
                <div className="form_field" key="tablenum">
                    <label className="form_label">
                        Table Number
                    </label>
                    <Select className="form_select" options={options} onChange={(options) => setTableNum(options.value)} />
                </div>
                <input className="btn" type="submit" onClick={() => setStart(true)}></input>
            </div>
            {error ?
                <>
                    <p className="error_msg">Please enter both your name and table number before starting your order.</p>
                </> : null
            }
        </div>
    );
